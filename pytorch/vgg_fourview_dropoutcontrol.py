...
class VGG_4view(nn.Module):

    def __init__(self, features1, features2, features3, features4, num_classes=1000, dropout_prob = 0.5, init_weights=True):
        super(VGG_4view, self).__init__()
        self.features1 =  copy.deepcopy(features1)
        self.features2 =  copy.deepcopy(features2)
        self.features3 =  copy.deepcopy(features3)
        self.features4 =  copy.deepcopy(features4)
        self.classifier = nn.Sequential(
            nn.Linear(512 * 7 * 7 * 4, 4096),
            nn.ReLU(True),
...
def vgg16(pretrained=False, dropout_prob=0.5, num_classes_modified=3, **kwargs):
    ...
    model_4view = VGG_4view(features1 = model.features, features2 = model.features, features3 = model.features, features4 = model.features, num_classes = num_classes_modified, dropout_prob = dropout_prob)
