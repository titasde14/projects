...
__all__ = ['InceptionTwoView', 'inception_twoview']
...
def inception_twoview(pretrained=False, **kwargs):
...
#        torch.manual_seed(manual_seed)
        ...
        if aux_logits:
            self.AuxLogits_TwoView = InceptionAux_TwoView(768, num_classes, self.training, dropout_prob, aux_dropout)
        ...
        self.fc_twoview = nn.Linear(2048*2, num_classes)
    ...
    def load_from_pretrained(self, model_pt):
        ...
        if self.aux_logits:
            self.AuxLogits_TwoView.conv0_1 = copy.deepcopy(model_pt.AuxLogits.conv0)
            self.AuxLogits_TwoView.conv1_1 = copy.deepcopy(model_pt.AuxLogits.conv1)
            self.AuxLogits_TwoView.conv1_1.stddev = copy.deepcopy(model_pt.AuxLogits.conv1.stddev)
            self.AuxLogits_TwoView.conv0_2 = copy.deepcopy(model_pt.AuxLogits.conv0)
            self.AuxLogits_TwoView.conv1_2 = copy.deepcopy(model_pt.AuxLogits.conv1)
            self.AuxLogits_TwoView.conv1_2.stddev = copy.deepcopy(model_pt.AuxLogits.conv1.stddev)
            self.AuxLogits_TwoView.fc_twoview.stddev = copy.deepcopy(model_pt.AuxLogits.fc.stddev)
    ...
    def forward(self, x1, x2):
        ...
        if self.training and self.aux_logits:
            aux = self.AuxLogits_TwoView(x1,x2)
        # 17 x 17 x 768
...
class InceptionAux_TwoView(nn.Module):
    ...
    def __init__(self, in_channels, num_classes, training=False, dropout_prob=1.0, aux_dropout=False):
        ...
        self.fc_twoview = nn.Linear(768*2, num_classes)
        self.fc_twoview.stddev = 0.001
